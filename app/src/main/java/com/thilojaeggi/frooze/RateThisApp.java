...
public class RateThisApp {
    ...
    private static void showRateDialog(final Context context, AlertDialog.Builder builder) {
        ...
        int cancelButtonID = sConfig.mCancelButton != 0 ? sConfig.mCancelButton : R.string.rate_dialog_action_never;
        int thanksButtonID = sConfig.mNoButtonId != 0 ? sConfig.mNoButtonId : R.string.rate_dialog_action_later;
        int rateButtonID = sConfig.mYesButtonId != 0 ? sConfig.mYesButtonId : R.string.rate_dialog_action_rate;
